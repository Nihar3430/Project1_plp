...
public interface delphiVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link delphiParser#constructorDecleration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructorDecleration(delphiParser.ConstructorDeclerationContext ctx);
	/**
	 * Visit a parse tree produced by {@link delphiParser#destructorDecleration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDestructorDecleration(delphiParser.DestructorDeclerationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link delphiParser#call_Designator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCall_Designator(delphiParser.Call_DesignatorContext ctx);
	/**
