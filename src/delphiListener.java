...
public interface delphiListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link delphiParser#classHeritage}.
	 * @param ctx the parse tree
	 */
	void enterClassHeritage(delphiParser.ClassHeritageContext ctx);
	/**
	 * Exit a parse tree produced by {@link delphiParser#classHeritage}.
	 * @param ctx the parse tree
	 */
	void exitClassHeritage(delphiParser.ClassHeritageContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link delphiParser#constructorDecleration}.
	 * @param ctx the parse tree
	 */
	void enterConstructorDecleration(delphiParser.ConstructorDeclerationContext ctx);
	/**
	 * Exit a parse tree produced by {@link delphiParser#constructorDecleration}.
	 * @param ctx the parse tree
	 */
	void exitConstructorDecleration(delphiParser.ConstructorDeclerationContext ctx);
	/**
	 * Enter a parse tree produced by {@link delphiParser#destructorDecleration}.
	 * @param ctx the parse tree
	 */
	void enterDestructorDecleration(delphiParser.DestructorDeclerationContext ctx);
	/**
	 * Exit a parse tree produced by {@link delphiParser#destructorDecleration}.
	 * @param ctx the parse tree
	 */
	void exitDestructorDecleration(delphiParser.DestructorDeclerationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link delphiParser#call_Designator}.
	 * @param ctx the parse tree
	 */
	void enterCall_Designator(delphiParser.Call_DesignatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link delphiParser#call_Designator}.
	 * @param ctx the parse tree
	 */
	void exitCall_Designator(delphiParser.Call_DesignatorContext ctx);
	/**
